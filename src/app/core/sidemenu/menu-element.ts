export const menus = [
...

  {
    ...
    sub: [
      ...
      {
        name: 'Why Choose Mahavir',
        link: 'home/whychoosemahavir',
        icon: 'list',
        chip: false,
        open: false
      },
...

  {
    ...
    sub: [
      ...
      },
      {
        ...
        link: 'aboutus/aboutbusinesstechnology',
        icon: 'list',
        chip: false,
        open: false
      },
...

  {
    ...
    sub: [
      ...
      {
        name: 'Solution ContactUs',
        link: 'solutioncontactus',
        icon: 'list',
        chip: false,
        open: false
      }
...

  {
    ...
    link: false,
    open: false,
    chip: { value: 7, color: 'accent' },
    sub: [
      {
        name: 'Mahavir-AV-Solution',
        link: 'footer/mahavirAvSolution',
        icon: 'list',
        chip: false,
        open: false
      },
  ...
  //         },
  //         {
  //             'name': 'Process Cycle Main',
  //             'icon': 'filter_center_focus',
  //             'link': 'tables/responsive',
  //             'open': false,
  //         },
  //         {
  //             'name': 'Process Cycle Content',
  //             'icon': 'filter_center_focus',
  //             'link': 'tables/responsive',
  //             'open': false,
  //         }
  ...
  //         },
  //         {
  //             'name': 'Our Process Cycle',
  //             'icon': 'filter_center_focus',
  //             'link': 'tables/responsive',
  //             'open': false,
  //         },
  //         {
  //             'name': 'Need Of Email Marketing',
  //             'icon': 'filter_center_focus',
  //             'link': 'tables/responsive',
  //             'open': false,
  //         },
  ...
  //         },
  //         {
  //             'name': 'What is Appointment Generation',
  //             'icon': 'done_all',
  //             'link': 'tables/featured',
  //             'open': false,
  //         },
  //         {
  //             'name': 'Advantages of Appointment Generation',
  //             'icon': 'filter_center_focus',
  //             'link': 'tables/responsive',
  //             'open': false,
  //         },
  ...
  //         },
  //         {
  //             'name': 'Big Data Analytics services',
  //             'icon': 'filter_center_focus',
  //             'link': 'tables/responsive',
  //             'open': false,
  //         },
  ...
  //         },
  //         {
  //             'name': 'Working At Coledab2b',
  //             'icon': 'done_all',
  //             'link': 'tables/featured',
  //             'open': false,
  //         },
  //         {
  //             'name': 'Working At Coledab2b Description',
  //             'icon': 'filter_center_focus',
  //             'link': 'tables/responsive',
  //             'open': false,
  //         },
