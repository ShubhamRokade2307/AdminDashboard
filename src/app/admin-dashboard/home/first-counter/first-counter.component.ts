...
@Component({
  selector: 'app-first-counter',
  templateUrl: './first-counter.component.html',
  styleUrls: ['./first-counter.component.scss']
})
export class FirstCounterComponent implements OnInit {
...
getEmploye()
{
  ...
  createEmployee() {
    // console.log(this.memberform.value.Heading)
    const Heading = this.memberform.value.Heading;
    const Text = this.memberform.value.Text;
    const dataToSend = { Heading, Text };
