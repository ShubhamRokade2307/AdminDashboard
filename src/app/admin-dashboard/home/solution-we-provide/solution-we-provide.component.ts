...
@Component({
  selector: 'app-solution-we-provide',
  templateUrl: './solution-we-provide.component.html',
  styleUrls: ['./solution-we-provide.component.scss']
})
export class SolutionWeProvideComponent implements OnInit {
