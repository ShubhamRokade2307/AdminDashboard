...
@Component({
  selector: 'app-home-partnars',
  templateUrl: './home-partnars.component.html',
  styleUrls: ['./home-partnars.component.scss']
})
export class HomePartnarsComponent implements OnInit {
