...
@Component({
  selector: 'app-what-we-built',
  templateUrl: './what-we-built.component.html',
  styleUrls: ['./what-we-built.component.scss']
})
export class WhatWeBuiltComponent implements OnInit {
