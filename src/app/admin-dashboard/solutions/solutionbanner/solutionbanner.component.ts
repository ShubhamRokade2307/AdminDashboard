...
@Component({
  selector: 'app-solutionbanner',
  templateUrl: './solutionbanner.component.html',
  styleUrls: ['./solutionbanner.component.scss']
})
export class SolutionbannerComponent implements OnInit {
