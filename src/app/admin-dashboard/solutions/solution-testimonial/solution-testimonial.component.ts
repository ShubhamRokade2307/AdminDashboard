...
@Component({
  selector: 'app-solution-testimonial',
  templateUrl: './solution-testimonial.component.html',
  styleUrls: ['./solution-testimonial.component.scss']
})
export class SolutionTestimonialComponent implements OnInit {
