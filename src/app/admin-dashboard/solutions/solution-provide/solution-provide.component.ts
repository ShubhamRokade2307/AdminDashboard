...
@Component({
  selector: 'app-solution-provide',
  templateUrl: './solution-provide.component.html',
  styleUrls: ['./solution-provide.component.scss']
})
export class SolutionProvideComponent implements OnInit {
