...
@Component({
  selector: 'app-about-increasing-business',
  templateUrl: './about-increasing-business.component.html',
  styleUrls: ['./about-increasing-business.component.scss']
})
export class AboutIncreasingBusinessComponent implements OnInit {
