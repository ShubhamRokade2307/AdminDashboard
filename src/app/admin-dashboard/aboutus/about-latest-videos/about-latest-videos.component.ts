...
@Component({
  selector: 'app-about-latest-videos',
  templateUrl: './about-latest-videos.component.html',
  styleUrls: ['./about-latest-videos.component.scss']
})
export class AboutLatestVideosComponent implements OnInit {
