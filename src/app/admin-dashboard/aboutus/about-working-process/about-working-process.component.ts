...
@Component({
  selector: 'app-about-working-process',
  templateUrl: './about-working-process.component.html',
  styleUrls: ['./about-working-process.component.scss']
})
export class AboutWorkingProcessComponent implements OnInit {
