...
@Component({
  selector: 'app-about-services-for-business',
  templateUrl: './about-services-for-business.component.html',
  styleUrls: ['./about-services-for-business.component.scss']
})
export class AboutServicesForBusinessComponent implements OnInit {
